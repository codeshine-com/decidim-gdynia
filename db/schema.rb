...
ActiveRecord::Schema[7.0].define(version: 2026_02_04_231032) do
  ...
  create_table "decidim_assemblies_extended_cadencies", force: :cascade do |t|
    t.jsonb "name"
    t.integer "weight", null: false
    t.bigint "decidim_assembly_id", null: false
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.index ["decidim_assembly_id"], name: "decidim_assembly_assemblies_extended_cadency"
  end
  ...
  create_table "decidim_assembly_members", force: :cascade do |t|
    ...
    t.string "avatar"
    t.bigint "decidim_assemblies_extended_cadency_id"
    t.index ["decidim_assemblies_extended_cadency_id"], name: "decidim_assembly_members_on_cadency_id"
  ...
  create_table "decidim_surveys_surveys", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.boolean "visible_for_unregistered", default: false
    t.datetime "deleted_at"
  ...
  create_table "decidim_users", id: :serial, force: :cascade do |t|
    ...
    t.string "district"
    t.string "inhabitant_card_number"
