...
Decidim::Webpacker.register_entrypoints(
  dates: "#{base_path}/app/packs/entrypoints/dates.js",
...
Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/processes_extended/processes_extended")

# If you want to do the same but include the SCSS file for the admin panel's
# main SCSS file, you can use the following method.
# Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/core_extended/admin", group: :admin)
...
# Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/core_extended/settings", type: :settings)

# If you want to do the same but override the SCSS variables of the admin
# panel's styles, you can use the following method.
# Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/core_extended/admin_settings", type: :settings, group: :admin)