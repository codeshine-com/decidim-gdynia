...
class DynamicFieldsLisComponent {
  constructor(options = {}) {
  ...
  // metrics - new LIS parametr for metrics
...
export default function createDynamicFieldsLis(options) {
  return new DynamicFieldsLisComponent(options);
}
