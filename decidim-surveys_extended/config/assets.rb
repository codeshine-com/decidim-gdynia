...
Decidim::Webpacker.register_entrypoints(
  decidim_forms_admin_lis: "#{base_path}/app/packs/entrypoints/decidim_forms_admin_lis.js",
...
Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/surveys_extended/surveys_extended")
...
# Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/admin_extended/settings", type: :settings)

# If you want to do the same but override the SCSS variables of the admin
# panel's styles, you can use the following method.
# Decidim::Webpacker.register_stylesheet_import("stylesheets/decidim/admin_extended/admin_settings", type: :settings, group: :admin)